  ...
  <div class="card-body">
    <form action="{{ route('teachers.update', $teacher) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="emp_no" id="emp_no" class="form-control" value="{{ old('emp_no', $teacher->emp_no) }}" required>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="designation" id="designation" class="form-control" value="{{ old('designation', $teacher->designation) }}">
      </div>

      <div class="mb-3">
        <label for="hire_date" class="form-label">Hire Date</label>
        <input type="date" name="hire_date" id="hire_date" class="form-control" value="{{ old('hire_date', $teacher->hire_date) }}">
      </div>
